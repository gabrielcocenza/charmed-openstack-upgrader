...
def get_process_id_list(unit_name, process_name, expect_success=True, pgrep_full=False):
    ...
    :raises: cou_exceptions.ProcessIdsFailed
    """
    if pgrep_full:
...
def validate_unit_process_ids(expected, actual):
    ...
    :raises: cou_exceptions.UnitCountMismatch
    :raises: cou_exceptions.UnitNotFound
    :raises: cou_exceptions.ProcessNameCountMismatch

...
def status():
    ...
    mock_units_keystone.workload_version = "2:17.0.1-0ubuntu1"
    ...
    mock_units_cinder.workload_version = "2:16.4.2-0ubuntu2.2~cloud0"
    ...
    mock_units_keystone_wallaby.workload_version = "2:18.1.0-0ubuntu1~cloud0"
